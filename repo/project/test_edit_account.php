...
<form method="POST">
    ...
    <select name="account_type" value="<?php echo $result["account_type"];?>">
        <option value="Checkings" <?php echo ($result["account_type"] == "Checkings"?'selected="selected"':'');?>>Checkings</option>
        <option value="Savings" <?php echo ($result["account_type"] == "Savings"?'selected="selected"':'');?>>Savings</option>
        <option value="Loans" <?php echo ($result["account_type"] == "Loans"?'selected="selected"':'');?>>Loans</option>
    </select>
    <label>Balance</label>
